...
public class WaitsPractice {
    ...
    public void test2(){
        ...
        //we create object to WebDriverWait to apply explicit wait
        //we must provide webDriver object and period of tome
        //within this period of time selenium will check every 500 milliseconds
        //if condition is true, if condition has met, no need to wait lomger
